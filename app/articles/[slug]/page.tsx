...
> = {
  'ai-opportunity-pest-control': {
    ...
    sources: [
      { id: '1', text: 'IBISWorld, "Pest Control in the US - Market Size," 2025' },
      { id: '2', text: 'IMARC Group, "U.S. Pest Control Market Size, Share, Trends 2025-2033"' },
      { id: '3', text: 'WorkWave, "Pest Control Industry Trends: Key Statistics to Watch in 2025"' },
    ],
  },
  'understanding-customer-churn': {
    ...
    sources: [
      { id: '1', text: 'FieldRoutes, "How To Retain Pest Control Customers," 2024' },
      { id: '2', text: 'Cube Creative Design, "Pest Control ROI: Stop Wasting Your Marketing Budget"' },
      { id: '3', text: 'Harvard Business Review, "The Value of Keeping the Right Customers," October 2014' },
      { id: '4', text: 'Bain & Company, Customer Retention Research by Frederick Reichheld' },
      { id: '5', text: 'PCT Online, "Customer Retention is Key to Profitable Growth," 2014' },
    ],
  },
  'seasonal-intelligence-competitive-advantage': {
    ...
    sources: [
      { id: '1', text: 'National Pest Management Association, "Seasonal Pest Trends"' },
  ...
  'hidden-cost-disconnected-systems': {
    ...
    sources: [
      { id: '1', text: 'Intuit, "2024 Small Business Software Integration Survey"' },
      { id: '2', text: 'Arrivy, "Why Integrated Software Systems Are Key to Scalable Field Service Management"' },
      { id: '3', text: 'NetSuite, "Field Service Management Challenges and Solutions"' },
    ],
  },
  'technology-creates-elite-field-performance': {
    ...
    sources: [
      ...
      { id: '2', text: 'FieldConnect, "Field Service Metrics & KPIs That Boost Efficiency"' },
    ],
  },
  'smart-scheduling-reduces-windshield-time': {
    ...
    sources: [
      { id: '1', text: 'Zuper, "Field Service Management KPIs"' },
      { id: '2', text: 'Field Nation, "Minimizing Windshield Time for Maximum Productivity"' },
      { id: '3', text: 'Energy Magazine, "Boosting Technician Productivity: The Hidden Cost of Windshield Time"' },
      { id: '4', text: 'GSM Tasks, "Route Optimization Helps Reduce Fuel Costs Up to 30%"' },
      { id: '5', text: 'Geotab, "Fleet Fuel Efficiency: Tactics to Cut Costs"' },
    ],
  },
  'data-driven-pricing-pest-control': {
    ...
    sources: [
      ...
      { id: '2', text: 'Harvard Business Review, "How to Stop Customers from Fixating on Price"' },
      { id: '3', text: 'Professional Pricing Society, "Pricing Best Practices"' },
    ],
  },
};
