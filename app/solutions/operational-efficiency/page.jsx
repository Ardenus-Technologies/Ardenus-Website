...
export default function OperationalEfficiency() {
  ...
  const images = [
    { src: '/demo-operational-3.png', alt: 'Operational Efficiency Demo 3' },
    { src: '/demo-operational-2-new.png', alt: 'Operational Efficiency Demo 2' },
    { src: '/demo-operational-1.png', alt: 'Operational Efficiency Demo 1' }
  ]
