...
const solutions = [
  ...
  },
  {
    ...
    images: [
      '/software/solutions-growth-left.png',
      '/software/solutions-growth-right.png',
    ],
    overlays: [
      [
        {
  ...
  },
  {
    ...
    images: [
      '/software/solutions-api-left.png',
      '/software/solutions-api-right.png',
    ],
    overlays: [
      [
        {
  ...
  return (
    <>
        ...
        <div className="relative z-10 mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8">
          ...
          <FadeIn delay={0.1}>
            <p className="text-body-lg mt-8 max-w-3xl text-white/80">
              From operational efficiency to revenue intelligence, our solutions
              are designed to solve the specific challenges facing modern pest
              control operators.
            </p>
          </FadeIn>
        </div>
      ...
      {solutions.map((solution, index) => (
        <section key={solution.number} className="bg-black">
              ...
              >
                {[0, 1].map((imgIndex) => (
                  <FadeIn key={imgIndex} delay={0.3 + imgIndex * 0.1}>
                    <div className="group relative aspect-[16/9] cursor-pointer overflow-hidden bg-[#1a1a1a]">
                      {/* Image */}
                      {solution.images ? (
                        <Image
                          ...
                          className="object-cover object-left-top transition-all duration-500 group-hover:scale-105 group-hover:blur-sm"
                        />
                      ) : (
                        <div
                      ...
                      {/* Text overlay */}
                      <div className="absolute inset-0 flex flex-col justify-center p-6 opacity-0 transition-all duration-500 group-hover:opacity-100 sm:p-10">
