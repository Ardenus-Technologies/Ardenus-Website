      ...
      <section className="relative min-h-[60vh] flex items-center justify-center bg-gradient-to-br from-[#122b3e] to-[#1a3a50] pt-32">
        <div className="max-w-6xl mx-auto px-6 lg:px-12 text-center">
          ...
          <p
            ...
            style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}
          >
            Uncover hidden revenue opportunities using your data
          </p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-6 lg:px-12">
          <div className="text-center mb-16">
            ...
            <p
              ...
              style={{ fontFamily: '"Helvetica Neue", Helvetica, Arial, sans-serif' }}
            >
              This is a placeholder page. Add your custom content here to showcase how your solution uncovers hidden revenue opportunities using data.
            </p>
          </div>
        </div>
      </section>
